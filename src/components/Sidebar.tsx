...
const Sidebar = forwardRef<HTMLElement, SidebarProps>(
  (
    ...
    return (
      <aside
        ref={ref}
        className={`glass ${isSidebarOpen ? "sidebar-open" : ""}`}
        style={{
              ...
              >
                <div
                  style={{
                    ...
                    height: "6px",
                    borderRadius: "50%",
                    backgroundColor: isFetchingModels
                      ? "hsl(35, 90%, 55%)"
                      : isConnected
                        ? "hsl(var(--accent-emerald))"
                        : "hsl(0, 80%, 50%)",
                    boxShadow: isFetchingModels
                      ? "0 0 8px hsl(35, 90%, 55%)"
                      : isConnected
                        ? "0 0 8px hsl(var(--accent-emerald))"
                        : "0 0 8px hsl(0, 80%, 50%)",
                ...
                <span
                  style={{
                    fontSize: "0.7rem",
                    color: isFetchingModels
                      ? "hsl(35, 90%, 55%)"
                      : isConnected
                        ? "hsl(var(--text-main) / 0.7)"
                        : "hsl(var(--text-muted))",
                    fontWeight: "500",
                  }}
                >
